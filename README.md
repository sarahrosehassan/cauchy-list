# Cauchy List ➕➖✖️
A Cauchy List is a list associated with arithmetic operations.(I enjoy seeing the worlds of mathematics and computer science collide)

With this program we can perform the operations on lists with the symbols + - and * in Python.
...
# Multiplication
Each element is given by this custom formula with mod p.
...
The simpler scalar product, multiplying each element by the constant can be calculated as well (with mod p of course).
...
# Multiple Operations
Can perform multiple operations at once with mutliple lists.
